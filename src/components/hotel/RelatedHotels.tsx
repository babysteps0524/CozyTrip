...
export default function RelatedHotels({ hotels, currentHotelId }: RelatedHotelsProps) {
  ...
  const relatedHotels = hotels
    ...
    .sort((a, b) => {
      const aSameArea = currentHotel?.area && a.area === currentHotel.area ? 1 : 0;
      const bSameArea = currentHotel?.area && b.area === currentHotel.area ? 1 : 0;
    ...
    >
      <Container>
        <div py="12 sm:16">
          ...
          <h2 id="related-hotels-title" mt="2" mb="0" text="2xl sm:3xl" font="bold" tracking="tight">
            함께 살펴볼 호텔
          </h2>
