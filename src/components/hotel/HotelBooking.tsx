        ...
        <div className="py-12 sm:py-16">
          <div className="overflow-hidden rounded-card border border-ct-line bg-ct-primary-soft dark:border-ct-dark-line dark:bg-ct-dark-surface-soft">
            <div className="p-4 sm:p-8">
              ...
              <h2 className="mt-2 mb-0 text-2xl font-bold leading-tight tracking-tight sm:text-3xl">
                예약 조건 확인
              </h2>
                    ...
                    {affiliateLinks.map((affiliateLink) => {
                      ...
                      return (
                        <a
                          ...
                          className="ct-focus group flex min-h-28 items-center justify-between gap-3 rounded-2xl border border-ct-line bg-ct-surface px-4 py-4 text-ct-text shadow-card transition-transform duration-150 hover:-translate-y-0.5 hover:shadow-soft active-scale-99 dark:border-ct-dark-line dark:bg-ct-dark-surface dark:text-ct-dark-text dark:hover:bg-ct-dark-surface-soft sm:gap-4 sm:px-5"
                        >
                          <span className="min-w-0">
                            <span className="block text-base font-bold leading-6">{label}</span>
            ...
            <div className="border-t border-ct-line bg-ct-surface/70 px-4 py-4 dark:border-ct-dark-line dark:bg-ct-dark-surface/70 sm:px-8">
              <p className="m-0 text-xs leading-6 text-ct-muted dark:text-ct-dark-muted">
