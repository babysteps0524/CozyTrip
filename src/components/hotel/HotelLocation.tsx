...
function getAreaLabel(hotel: Hotel): string {
  return [hotel.location.city, hotel.location.area]
    .filter(Boolean)
    .join(" · ");
}
...
export default function HotelLocation({ hotel }: HotelLocationProps) {
  ...
  const areaLabel = getAreaLabel(hotel);
        ...
        <div py="12 sm:16 lg:20">
          ...
          <div mt="8" grid="~ cols-1 lg:2" gap="5 lg:6">
            <div
              ...
              p="6"
            >
              <p m="0" text="xs ct-muted dark:ct-dark-muted" font="medium">
                지역
              </p>
              ...
              {location.prefecture && (
                ...
                >
                  {location.country} · {location.prefecture}
                </p>
              )}
              ...
              {mapUrl && (
                <a
                  ...
                  aria-label={`${hotel.name} 지도에서 위치 확인`}
                  mt="6"
                  display="inline-flex"
                  items="center"
                  justify="center"
            ...
            >
              ...
              {stations.length > 0 ? (
                <ul
                  ...
                  list="none"
                  p="0"
                  divide="y ct-line dark:divide-ct-dark-line"
                >
              ...
              <p
                mt="6"
                mb="0"
                text="xs ct-muted dark:text-ct-dark-muted"
                leading="relaxed"
              >
                가까운 역 정보는 제공된 호텔 데이터에 등록된 내용을 표시합니다.
                이동 시간이나 실제 경로는 지도와 현지 안내를 함께 확인해 주세요.
              </p>
            </div>
          </div>
