...
export const HOTEL_POST_PROMPT_VERSION = "hotel-post-v4";
...
특히 "가깝다", "편리하다", "다양하다", "쾌적하다", "편안하다", "인기 있다", "추천한다", "중심부", "주요 관광지", "여행하기 좋다", "이동이 쉽다"와 같은 평가·추정 표현은 데이터에 직접 근거가 있을 때만 사용해라.
...
- 가능한 경우 위치, 숙소 기본 정보, 시설, 식음료, 체크인/체크아웃, 제공된 역 정보 등을 다루되 데이터가 없는 주제는 "제공된 데이터에서 확인되지 않습니다"라고 짧게 안내하거나 확인 가능한 다른 주제로 대체한다.
